<template>
  ...
  >
    <template v-if="!expanded">
      <button class="__va-toolbar-toggle" @click="onActivate" title="Agentation Vue">
    ...
    <template v-else>
      ...
      <div class="__va-toolbar-sep"></div>
      ...
      <!-- Settings -->
      <VaIconButton title="Settings" @click="$emit('open-settings')">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
